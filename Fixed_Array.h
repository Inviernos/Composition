 ...
 */
  ...
  // COMMENT: This approach will hide the base class resize() , but it
  // will fail if I have a Array reference to a Fixed_Array.
  
  //I address this comment by deleting the resize method and making
  //another class that is my base for Arrays
